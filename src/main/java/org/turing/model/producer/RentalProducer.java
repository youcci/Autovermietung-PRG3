...
public class RentalProducer {
    ...
    private static void produce() {
        ...
        list.add(new Rental("01.06.2017", carService.findById(5L), customerService.findById(2L),
                employeeService.findById(3L), "10.06.2017", 0, ""));
        ...
        list.add(new Rental("25.03.2018", carService.findById(6L), customerService.findById(10L),
                employeeService.findById(3L), "03.05.2018", 0, ""));
